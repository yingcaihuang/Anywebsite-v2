...
// 运行完整测试
func runCompleteTest() error {
	fmt.Println("🚀 开始运行完整API测试")
	fmt.Println(strings.Repeat("=", 50))

	// 创建测试客户端，使用配置文件中的API密钥
...
<pre><code>func main() {
	...
	updateReq := UpdateArticleRequest{
		Title: "更新后的Go API测试文章",
		Content: `<h1>这是更新后的Go API测试文章</h1>
...
<p><em>更新时间: ` + time.Now().Format("2006-01-02 15:04:05") + `</em></p>`,
	...
	if !strings.Contains(webContent, "<h1>这是更新后的Go API测试文章</h1>") {
...
func main() {
	...
	// 运行完整API测试
	if err := runCompleteTest(); err != nil {
